package TFIP.workshop14.redo.Model;
...
public class ContactModel implements Serializable {
    ...
    public ContactModel(String id, String name, String email, String phoneNumber, LocalDate dateOfBirth, int age) {
        this.id = generateId(8);
        this.name = name;
        this.email = email;
    ...
    public void setDateOfBirth(LocalDate dateOfBirth) {
        ...
        int calcualteAge = 0;
        if (dateOfBirth != null) {
            calcualteAge = Period.between(dateOfBirth, LocalDate.now()).getYears();
        }
        this.age = calcualteAge;
    }
